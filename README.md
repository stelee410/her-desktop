...
Plugin lifecycle management is also capability-backed: `plugin.install` installs generated packages after approval, and `plugin.remove` removes installed `local.*` plugins after approval.
