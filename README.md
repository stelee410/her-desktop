...
Pasted PluginPackage JSON or a selected `.plugin-package.json` file is staged into the same generated-drafts review queue before installation, either from the UI composer or through the `plugin.stagePackage` capability.
