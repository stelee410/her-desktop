...
struct SystemPromptBuilder {
    ...
    private var extensionPolicy: String {
        ...
        Prefer the plugin.draft, plugin.stagePackage, plugin.listDrafts, plugin.listInstalled, plugin.installDraft, plugin.discardDraft, plugin.install, plugin.export, and plugin.remove capabilities over hand-waving when the user wants to create, import, inspect, install, update, back up, or remove extensions.
