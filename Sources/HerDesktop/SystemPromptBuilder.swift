...
struct SystemPromptBuilder {
    ...
    private var extensionPolicy: String {
        ...
        Prefer the plugin.draft, plugin.installDraft, plugin.discardDraft, plugin.install, and plugin.remove capabilities over hand-waving when the user wants to create, install, update, or remove extensions.
