...
final class AppViewModel: ObservableObject {
    ...
    private func exportProductDiagnosticsCapability(arguments: [String: Any]) -> CapabilityResult {
    ...
    private func productDiagnosticsSnapshot() -> String {
    ...
    private func safeDiagnosticsFilename(_ raw: String) -> String {
