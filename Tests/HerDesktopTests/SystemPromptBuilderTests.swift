...
final class SystemPromptBuilderTests: XCTestCase {
    func testPromptKeepsMemoryAsDataAndIncludesPlugins() {
        ...
        XCTAssertTrue(prompt.contains("plugin.draft, plugin.stagePackage, plugin.listDrafts, plugin.installDraft, plugin.discardDraft, plugin.install, plugin.export, and plugin.remove"))
